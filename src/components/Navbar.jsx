...
const Navbar = () => {
  ...
  return (
    <>
      <div className='relative bg-[#fffff] z-50'>
        <nav className='container mx-auto flex items-center justify-between p-5 bg-[#fffff]'>
          <div>
            ...
            <div className='hidden lg:block'>
              {!user?.token ? (
                <Link to='/user-auth'>
                  <CustomButton
                    title='Register'
                    containerStyles='text-green-600 py-1.5 px-5 focus:outline-none hover:bg-green-700 hover:text-white rounded-full text-base border border-green-600'
                  />
                </Link>

...
import { AiOutlineSearch, AiOutlineCloseCircle, AiOutlineDollar } from "react-icons/ai";
      ...
      >
        <div className='w-full z-10'>
          <div className="flex justify-between">
            <div className='mb-8 max-w-xl items-end flex'>
          ...
          <div className='w-full flex items-center justify-around bg-white px-2 md:px-5 py-2.5 md:py-6 shadow-2xl rounded-full'>
            ...
            <SearchInput
              placeholder='Salary'
              icon={<AiOutlineDollar className='text-gray-600 text-xl' />}
              styles={"hidden md:flex"}
            />
        ...
        {/* <div className='w-1/3 h-full absolute top-24 md:-top-6 lg:-top-50 right-16 2xl:right-[18rem]'>
